...
// */
//
//GAUXMessage getMovesPawn(int square, SPArrayList* list, ChessGame* game);
//GAUXMessage getMovesBishop(int square, SPArrayList* list, ChessGame* game);
//GAUXMessage getMovesRook(int square, SPArrayList* list, ChessGame* game);
//GAUXMessage getMovesKnight(int square, SPArrayList* list, ChessGame* game);
//GAUXMessage getMovesKing(int square, SPArrayList* list, ChessGame* game);
//GAUXMessage getMovesQueen(int square, SPArrayList* list, ChessGame* game);
//
////-----------------------------------------------
//
//
